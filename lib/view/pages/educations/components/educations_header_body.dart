...
// and an image.
class EdcuationsHeaderBody extends StatelessWidget {
  const EdcuationsHeaderBody({
    Key? key,
  }) : super(key: key);
    ...
    return Row(
      children: <Widget>[
        ...
        SizedBox(
          ...
          child: Image.asset(CommonImageDirectory.imageEducationsHeader),
        ),
