...
// and an image.
class EducationSectionBody extends StatelessWidget {
  const EducationSectionBody({
    Key? key,
  }) : super(key: key);
    ...
    return Row(
      children: <Widget>[
        ...
        SizedBox(
          ...
          child: Image.asset("assets/images/educationSection.png"),
        ),
        SizedBox(width: size.width * 150 / 1280, height: 0),
      ],
    );
